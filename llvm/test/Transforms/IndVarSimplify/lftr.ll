...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[I]], 1000
...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i64 [[NEXT_ITER]], 100
...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[INDVARS_IV_NEXT]], 512
