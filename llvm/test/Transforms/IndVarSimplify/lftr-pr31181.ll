...
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[STOREMERGE]], -1
...
; CHECK-NEXT:    store i32 [[STOREMERGE]], ptr @a, align 4
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[STOREMERGE]], 2147483647
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[STOREMERGE]], 1
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP]], label [[EXIT:%.*]]
; CHECK:       exit:
; CHECK-NEXT:    ret i32 0
...
; CHECK-NEXT:    store i32 [[STOREMERGE]], ptr @a, align 4
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[STOREMERGE]], -2
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[STOREMERGE]], 1
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP]], label [[EXIT:%.*]]
; CHECK:       exit:
; CHECK-NEXT:    ret i32 0
...
; CHECK-NEXT:    [[STOREMERGE:%.*]] = phi i32 [ 0, [[ENTRY:%.*]] ], [ [[INC:%.*]], [[LOOP]] ]
; CHECK-NEXT:    store i32 [[STOREMERGE]], ptr @a, align 4
; CHECK-NEXT:    [[EXITCOND:%.*]] = icmp samesign ult i32 [[STOREMERGE]], 2147483646
; CHECK-NEXT:    [[INC]] = add nuw nsw i32 [[STOREMERGE]], 1
; CHECK-NEXT:    br i1 [[EXITCOND]], label [[LOOP]], label [[EXIT:%.*]]
; CHECK:       exit:
; CHECK-NEXT:    ret i32 0
